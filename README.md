...
<td>
  ...
  <br><b>NOTE for Windows User:</b> Animation will only work in <a href=https://devblogs.microsoft.com/commandline/introducing-windows-terminal>Windows Terminal</a> (available in Windows 10 and later), as `PowerShell` and `Command Prompt` do not support Escape Codes.</b>
</td>
<tr><td colspan="2">
